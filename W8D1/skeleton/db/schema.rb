...
ActiveRecord::Schema.define(version: 20200824122945) do
  ...
  create_table "toys", force: :cascade do |t|
    t.string "toyable_id_type"
    t.bigint "toyable_id_id"
    ...
    t.index ["toyable_id_type", "toyable_id_id"], name: "index_toys_on_toyable_id_type_and_toyable_id_id"
  end
